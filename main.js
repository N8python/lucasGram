...
ctx.fillText("Happy Birthday, Lucas! - The Lahey Bunch", width / 2, height / 2 - 100);
...
function animation() {
    ...
    if (firstFrame < 1401) {
        ...
        ctx.fillStyle = "Red";
        ctx.fillText("Lucas", 20 + firstFrame, 100);
        ctx.fillStyle = "Orange";
        ctx.fillText("Lucas", 1200 - firstFrame, 200);
        ctx.fillStyle = "Green";
        ctx.fillText("Lucas", 20 + firstFrame, 300);
        ctx.fillStyle = "Blue";
        ctx.fillText("Lucas", 1200 - firstFrame, 400);
